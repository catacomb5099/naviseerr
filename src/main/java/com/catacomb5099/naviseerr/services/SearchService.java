...
public class SearchService {
    ...
    Mono<LastFmSearchResponse> searchTracks(@PathVariable String query) {
        // TODO: log result count
        log.info("Received LastFM search request for query='{}'", query);
    ...
    Mono<LastFmSearchResponse> searchAlbums(@PathVariable String query) {
        // TODO: log result count
        log.info("Received LastFM search request for query='{}'", query);
    ...
    Mono<LastFmSearchResponse> searchArtists(@PathVariable String query) {
        // TODO: log result count
        log.info("Received LastFM search request for query='{}'", query);
